      ...
      <?php foreach($fiction as $f) : ?>
        ...
        <div class="card ml-3 mb-3" style="width: 16rem;">
          ...
          <div class="card-body">
            ...
            <br>
            <?php if($f->stok >0){
                    echo anchor('dashboard/add_shopping/'.$f->id_buku, '<div class="btn btn-sm btn-primary">Add to shopping cart</div>'); 
                    }else{
                    echo '<div class="btn btn-sm btn-primary" disabled>Sold Out</div>';
                    }
                ?>
            <?= anchor('dashboard/detail_buku/'.$f->id_buku, '<div class="btn btn-sm btn-success">Detail</div>'); ?>
          </div>
        </div>
